...
export declare type Model = Card | Catalog | GenericScryfallResponse | List<SingularEntity> | MagicSet;
export type { List, Card, MagicSet, Catalog, GenericScryfallResponse, SingularEntity, };
